...
var SliptestEditComponent = (function () {
    function SliptestEditComponent(route, cookieService, sliptestService) {
        this.route = route;
        ...
        this.sub = this.route.params.subscribe(function (params) {
            if (params['id'] !== undefined) {
                ...
                _this.sliptestService.getSliptest(_this.sectionId, _this.subjectId, sliptestId)
                    .then(function (sliptest) { return _this.sliptest = sliptest; });
            }
            else {
    ...
    SliptestEditComponent = __decorate([
        ...
        __metadata('design:paramtypes', [router_1.ActivatedRoute, core_2.CookieService, sliptest_service_1.SliptestService])
