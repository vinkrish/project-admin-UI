...
var ExamSubjectGroupService = (function () {
    function ExamSubjectGroupService(http, cookieService) {
        this.http = http;
    ...
    ExamSubjectGroupService.prototype.handleError = function (error) {
        console.error('An error occurred', error);
        return Promise.reject(error.message || error);
    };
    ExamSubjectGroupService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [http_1.Http, core_2.CookieService])
    ], ExamSubjectGroupService);
    return ExamSubjectGroupService;
}());
exports.ExamSubjectGroupService = ExamSubjectGroupService;
//# sourceMappingURL=exam-subject-group.service.js.map